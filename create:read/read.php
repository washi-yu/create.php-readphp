...
try{
    ...
    if($order === 'desc'){
         $sql_select = 'SELECT * FROM products WHERE product_nme LIKE :keyword ORDER BY update_at DESC';
       }else{
         $sql_select = 'SELECT * FROM products WHERE product_nme LIKE :keyword ORDER BY update_at ASC';
     }
